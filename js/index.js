! function(e) {
    ...
    function(e, t, n) {
        ...
        function A(e, n) {
            ...
            if (t.isFirstTouch === i && (t.isFirstTouch = A), A)
                for (c = e.touches.length ? e.touches[0] : e.changedTouches[0], S.x = a = c.pageX, S.y = s = c.pageY, S.target = b = c.target, S.identifier = c.identifier, S.touches = e.touches, t.prevBubbleHistory = t.currentBubbleHistory, l = t.currentBubbleHistory = S.bubbleHistory = []; b;) l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0),
                    b = b.parentNode;
            else
                for (S.identifier = 0, S.x = a = f ? e.pageX : e.clientX + h.scrollLeft, S.y = s = f ? e.pageY : e.clientY + h.scrollTop, S.target = b = e.target ? e.target : e.srcElement, t.prevBubbleHistory = t.currentBubbleHistory, l = t.currentBubbleHistory = S.bubbleHistory = []; b;) l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0),
                    b = b.parentNode;
            if (t.x = a, t.y = s, P) {
            ...
            i.add = a,
                ...
                i.remove = function(e, t) {
                    ...
                    var n, i = this._listeners,
                        r = i.length;
                    for (; r--;)
                        if ((n = i[r]).f === e && (!t || n.c === t)) return n.j = 0,
                            i.splice(r, 1), !0;
                    return !1
                },
    ...
    function(e, t, n) {
        ...
        t.preInit = function() {
            ...
            t.update = function(e) {
                oe(),
                    U += b._tPos < -1 ? -.03 : .05,
                    U = g.clamp(U, 0, 1),
                    O.opacity = U, !k && E < 1 && E !== b._tPos && (k = !0, v.setBaseText(""));
        ...
        function ae(e) {
            if (S = null, e.lang !== r.lang && (window.location.href = e.pathLangPrefix + e.pageUrl), e.aliasInfo)
                if (t.nextPathInfo = e, e.aliasInfo.isId) t.currPathInfo = t.nextPathInfo,
                    se(e.aliasInfo.ref);
                else {
    ...
    function(e, t, n) {
        ...
        t.init = function(e) {
                ...
                (M = new i.BufferGeometry).setAttribute("position", new i.BufferAttribute(ue, 3)),
    ...
    function(e, t, n) {
        ...
        function S(e) {
            ...
            for (var m = new Uint16Array(65024), p = 0, g = 0; p < 256; p++)
                for (var x = 0; x < 127; x++) m[g + 0] = 128 * p + x,
                    m[g + 1] = 128 * p + x + 1,
                    g += 2;
    ...
    function(e, t, n) {
        ...
        function A(e) {
            ...
            a.mouse.set(e.x, e.y - t), !r.isMobile && M && (a.prevMouse.copy(a.mouse), a.elasticMouse.copy(a.mouse), a.easedMouse.copy(a.mouse)),
                M = !1
        }
            ...
            void 0 !== global && (global.numeric = numeric),
                ...
                numeric.imageURL = function(e) {
                    ...
                    for (d = t(v, 12, 29), v[29] = d >> 24 & 255, v[30] = d >> 16 & 255, v[31] = d >> 8 & 255, v[32] = 255 & d, n = 1, i = 0, u = 0; u < f; u++) {
                        for (u < f - 1 ? v.push(0) : v.push(1), a = 3 * h + 1 + (0 === u) & 255, s = 3 * h + 1 + (0 === u) >> 8 & 255, v.push(a), v.push(s), v.push(255 & ~a), v.push(255 & ~s), 0 === u && v.push(0), c = 0; c < h; c++)
                            for (r = 0; r < 3; r++) i = (i + (n = (n + (a = (a = e[r][u][c]) > 255 ? 255 : a < 0 ? 0 : Math.round(a))) % 65521)) % 65521,
                                v.push(a);
                        v.push(0)
                    }
                    return l = (i << 16) + n,
                ...
                numeric.T.prototype.inv = function() {
                    ...
                    for (c = _ - 1; c > 0; c--)
                        for (o = y[c], a = w[c], l = c - 1; l >= 0; l--)
                            for (s = y[l], u = w[l], v = b[l][c], m = S[l][c], d = _ - 1; d >= 0; d--) p = o[d],
                                g = a[d],
                                s[d] -= v * p - m * g,
                                u[d] -= v * g + m * p;
                ...
                numeric.ccsDot = function(e, t) {
                    ...
                    for (r = 0; r !== b; ++r) {
                        for (o = p[r], a = p[r + 1], l = 0, i = o; i < a; ++i)
                            for (d = g[i], f = x[i], s = h[d], u = h[d + 1], n = s; n < u; ++n) 0 === T[c = v[n]] && (M[l] = c, T[c] = 1, l += 1),
                                S[c] = S[c] + m[n] * f;
                ...
                numeric.ccsGather = function(e) {
                    var t, n, i, r, o, a = e[0],
                        ...
                        h = Array(l);
                    for (o = 0, t = 0; t < c; ++t)
                        for (i = a[t], r = a[t + 1], n = i; n !== r; ++n) f[o] = t,
                            d[o] = s[n],
                            h[o] = u[n],
                            ++o;
                    return [d, f, h]
                ...
                numeric.spline = function(e, t, n, i) {
                    ...
                    if ("string" == typeof n)
                        for (r = h.length - 1; - 1 !== r; --r) h[r] = numeric.ccsLUPSolve(numeric.ccsLUP(numeric.ccsScatter(f)), a[r]),
                            h[r][o - 1] = h[r][0];
                    else
                        ...
                        function G() {
                            ...
                            if (f === i) v[x] = v[i];
                                ...
                                for (p = i; p >= f + 1 && 0 !== v[p] && (z = Math.max(Math.abs(v[p - 1]), Math.abs(v[p])), E = Math.min(Math.abs(v[p - 1]), Math.abs(v[p])), A = v[p - 1] >= 0 ? Math.abs(z * Math.sqrt(1 + E * E / (z * z))) : -Math.abs(z * Math.sqrt(1 + E * E / (z * z))), z = v[p - 1] / A, E = v[p] / A, 1 !== z); p -= 1)
                                    if (0 === z)
                                        for (v[p - 1] = E * A, g = 1; g <= i; g += 1) A = e[g][p - 1],
                                            e[g][p - 1] = e[g][p],
                                            e[g][p] = A;
                                    else
                                        for (v[p - 1] = A, k = E / (1 + z), g = 1; g <= i; g += 1) A = z * e[g][p - 1] + E * e[g][p],
                        ...
                        for (var S = 0; S < 50; S++) {
                            ...
                            if (!T) {
                                ...
                                for (o = u; o < s + 1 && (p = b * f[o], f[o] = r * f[o], !(Math.abs(p) <= n)); o++)
                                    for (x = m(p, g = h[o]), h[o] = x, r = g / x, b = -p / x, a = 0; a < l; a++) y = c[a][M],
                                        w = c[a][o],
                                        c[a][M] = y * r + w * b,
                                        c[a][o] = -y * b + w * r
                            }
                ...
                f = e,
                    function() {
                        for (var e = f.MAX_TUBE_COUNT,
                                ...
                                r = t + 2,
                                o = n + 2,
                                a = new Float32Array(4 * o * 3), s = new Float32Array(4 * o), c = 2 * Math.PI / 4, d = 0, h = 0, v = 0; d < o; d++)
        ...
        g.constructor = m,
            ...
            g.onClick = function(t) {
                if (!r._actionId && e.exports.isClickable) return S ^= 1,
                    r.playMixedAction(S),
                    u.playEffect(S ? "obstacle" : "obstacle2"), !0
            };
        var x = void 0,
            _ = void 0,
            y = void 0,
